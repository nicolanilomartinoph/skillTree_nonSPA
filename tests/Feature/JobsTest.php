...
class JobsTest extends TestCase
{
     ...
     * @return void
     */
    public function test_jobs_route_exist()
    {
        $this->withoutExceptionHandling();
    ...
    /** @test */
    public function job_selected_displays_correct_job_details()
    {
        $this->withoutExceptionHandling(); 
        // this should have a provider testing each job_name as an input using foreach 
        $this->assertTrue(true);
    }

    public function test_route_is_guest() 
    {
        $this->withoutExceptionHandling();
